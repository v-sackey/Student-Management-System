...
public class show_grades extends javax.swing.JFrame {
    ...
    public void showRecord() {
        try {
            ...
            String los = "SELECT grades.module_id AS MODLUES_ID, UPPER(module.intitule) AS MODULE_NAME, grades.teacher_id AS PROFESSOR, grades.score from grades, module WHERE student_id='" + sid.getText() + "' AND grades.module_id= module.id";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "SHOW GRADES", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 24))); // NOI18N
        ...
        jLabel3.setText("PLEASE ENTER YOUR ID");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(sid, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        setSize(new java.awt.Dimension(654, 429));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new show_grades().setVisible(true);
            }
        });
    }
